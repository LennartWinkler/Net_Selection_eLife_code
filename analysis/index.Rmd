...
We then expanded the model to include an interaction of mating system ('Mating_system') and sex (Table S4).
```{r, echo = T, results = 'hide'}
...
Secondly, we included an interaction of mating system ('Mating_system') and sex (Table S4).
```{r, echo = T, results = 'hide'}
...
Secondly, including an interaction of mating system ('Mating_system') and sex (Table S4).
```{r, echo = T, results = 'hide'}
...
We then first ran the MCMC models for the phenotypic variance in reproductive success in vertebrate species (Table S5).  
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the phenotypic variance in reproductive success in vertebrate species including an interaction of mating system ('Mating_system') and sex (Table S6).
```{r, echo = T, results = 'hide'}
...
Then we ran the MCMC models for the genetic variance in reproductive success in vertebrate species (Table S5).  
```{r, echo = T, results = 'hide'}
...
Next, we run the MCMC model for the genetic variance in reproductive success in vertebrate species including an interaction of mating system ('Mating_system') and sex (Table S6).
```{r, echo = T, results = 'hide'}
...
We then ran the MCMC models, first for the phenotypic variance in lifespan in vertebrate species (Table S5).  
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the phenotypic variance in lifespan in vertebrate species including an interaction of mating system ('Mating_system') and sex (Table S6).
```{r, echo = T, results = 'hide'}
...
Then we ran the MCMC models for the genetic variance in lifespan in vertebrate species (Table S5).  
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the genetic variance in lifespan in vertebrate species including an interaction of mating system ('Mating_system') and sex (Table S6).
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the genetic variance in reproductive success in socially monogamous vertebrate species (Table S5).
```{r, echo = T, results = 'hide'}
...
Then we ran the MCMC models for the phenotypic variance in reproductive success in polygamous vertebrate species (Table S5).
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the genetic variance in reproductive success in polygamous vertebrate species (Table S5).
```{r, echo = T, results = 'hide'}
...
First, the MCMC for the phenotypic variance in lifespan in socially monogamous vertebrate species (Table S5).  
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the genetic variance in lifespan in socially monogamous vertebrate species (Table S5).
```{r, echo = T, results = 'hide'}
...
Then we ran the MCMC models for the phenotypic variance in lifespan in polygamous vertebrate species (Table S5).
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC model for the genetic variance in lifespan in polygamous vertebrate species (Table S5).
```{r, echo = T, results = 'hide'}
...
We began with the phenotypic variance in reproductive success (Table S7).
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC exploring the effect of study type on the genetic variance in reproductive success (Table S7).
```{r, echo = T, results = 'hide'}
...
Then we ran the model for the phenotypic variance in lifespan (Table S7).
```{r, echo = T, results = 'hide'}
...
Finally, we explored the effect of study type on the genetic variance in lifespan (Table S7).
```{r, echo = T, results = 'hide'}
...
We began with the phenotypic variance in reproductive success (Table S8).
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC exploring the effect of the fitness estimate on the genetic variance in reproductive success (Table S8).
```{r, echo = T, results = 'hide'}
...
We began with the genetic variance in reproductive success (Table S9).
```{r, echo = T, results = 'hide'}
...
Next, we ran the MCMC exploring the effect of the reproductive success estimate on the genetic variance in lifespan (Table S9).
```{r, echo = T, results = 'hide'}
